...
//params is whatever is dynamic, so the tripId
export const loader = async ({ params }: LoaderFunctionArgs) => {
  const { tripdId } = params;
  if (!tripdId) {
    throw new Error("Trips ID is required");
  }

  //You can make both of these requests in parallel because they are independent of each other
